...
const badPresentationConfig: PresentationConfig = {
...
const needForSpeedPresentationConfig: PresentationConfig = {
  presentationId: "need-for-speed",
  presentationTitle: "Need for Speed",
  linkedInProfileUrl: "https://www.linkedin.com/in/todd-b-fisher/",
  linkedInProfileName: "Todd B Fisher",
  presentationUrl:
    "https://docs.google.com/presentation/d/1zs7pDdoLdQAmLg1JUUdn3qXAN-zBBu9AYIigH4AbQKE/embed",
  qrCodeImageUrl: "/images/qrcode.png",
  conferenceLogoUrl: "/images/utahjs_400x400.png",
  siteUrlLabel: "utahjs.vercel.app",
  questions: [
...
const aiCookbookLearningPresentationConfig: PresentationConfig = {
  presentationId: "ai-cookbook-learning",
  presentationTitle: "AI Cookbook Learning",
  linkedInProfileUrl: "https://www.linkedin.com/in/todd-b-fisher/",
  linkedInProfileName: "Todd B Fisher",
  presentationUrl:
    "https://docs.google.com/presentation/d/18xa-r19U5R2-onJ9qKq_DbBPvMr35PT72Gm2t9dttbc/embed",
  qrCodeImageUrl: "/images/qrcode.png",
  conferenceLogoUrl: "/images/utahjs_400x400.png",
  siteUrlLabel: "utahjs.vercel.app",
  questions: [
...
const makeWorkNotSuckPresentationConfig: PresentationConfig = {
  presentationId: "make-work-not-suck",
  presentationTitle: "Make Work Not Suck",
  linkedInProfileUrl: "https://www.linkedin.com/in/todd-b-fisher/",
  linkedInProfileName: "Todd B Fisher",
  presentationUrl:
    "https://docs.google.com/presentation/d/1boJkqqgG7snuiogSWsAhkGlWeGHbPeLVSkaq9CWJ5hM/embed",
  qrCodeImageUrl: "/images/qrcode.png",
  conferenceLogoUrl: "/images/utahjs_400x400.png",
  siteUrlLabel: "utahjs.vercel.app",
  questions: [
...
const presentationConfigs: Map<PresentationConfigId, PresentationConfig> =
  new Map([
    ["need-for-speed", needForSpeedPresentationConfig],
    ["ai-cookbook-learning", aiCookbookLearningPresentationConfig],
    ["make-work-not-suck", makeWorkNotSuckPresentationConfig],
    ["bad-id", badPresentationConfig],
  ]);

/** Statically set at BUILD time */
export const currentPresentationConfig: PresentationConfig =
  needForSpeedPresentationConfig;
